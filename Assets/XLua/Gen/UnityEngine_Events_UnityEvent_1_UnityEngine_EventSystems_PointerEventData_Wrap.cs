        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.PointerEventData>();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.PointerEventData> constructor!");
