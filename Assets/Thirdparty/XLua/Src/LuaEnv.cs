    ...
    public class LuaEnv : IDisposable
    {
        ...
        public LuaEnv()
        {
...
#endif
            {
                ...
                if (0 != LuaAPI.xlua_setglobal(rawL, "printWarning"))
                {
                    throw new Exception("call xlua_setglobal fail!");
                }
                ...
                LuaAPI.lua_pushstdcallcfunction(rawL, StaticLuaCallbacks.PrintInfo);
                if (0 != LuaAPI.xlua_setglobal(rawL, "printInfo"))
                {
                    throw new Exception("call xlua_setglobal fail!");
                }
#endif
        ...
        public delegate byte[] CustomLoader(ref string filepath, out int fileLength);
